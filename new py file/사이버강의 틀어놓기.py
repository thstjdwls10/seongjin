...
time.sleep(3)
win32api.GetCursorPos() #마우스 좌표 알아내기
...
d.get("two",print("sorry"))

list(d.keys())
d.values()

h=['hi','bye','sex']
d={value for key,value in enumerate(h)}
d1={value for key,value in enumerate(h) if not value=='sex'}
d1.add('yellow')
