# -*- coding: utf-8 -*-
"""
Created on Sat Nov  2 01:53:07 2019
...
#==============================================================================
# #준비단계
# #클립보드 다운http://blog.naver.com/PostView.nhn?blogId=sojumonika&logNo=220736025779&categoryNo=51&parentCategoryNo=0&viewDate=&currentPage=1&postListTopCurrentPage=1&from=postView
# #pip install  py win32 win32api, time, win32con, hgtk, win32gui
#==============================================================================
...
#KO_code 불러오기
KO_CODE={}
with open('C:/Users/seongjin.son/Documents/KO_CODE.txt','r') as f:
    for i in f.readlines():
        KO_CODE[i.strip().split()[0]]=i.strip().split()[1]
    KO_CODE['']=''
    KO_CODE[' ']=' '
...
def macro(k):
    for i in range(3):
        time.sleep(0.1)
        typer(KO_CODE[hgtk.letter.decompose(list(k)[0])[i]])
    ...
    for s in list(k)[1:]:
            if s==' ':
                ...
                for i in range(3):
                    typer(KO_CODE[hgtk.letter.decompose(s)[i]])
